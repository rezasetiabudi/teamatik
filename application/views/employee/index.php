        ...
        foreach ($list as $rows) {
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn" data-toggle="modal" data-target="#deleteModal<?php echo $rows['id'] ?>"><span class="glyphicon glyphicon-trash" style="color:red"></span></a>
            </td>
          </tr>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a type="button" class="btn btn-danger" href="<?php echo base_url('Employee/delete/') ?><?php echo $rows['id'] ?>">Delete</a>
                </div>
              </div>
            </div>
          </div>
